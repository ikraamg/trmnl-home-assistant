 ...
 *
 * Tests URL query parameter parsing and validation for screenshot requests.
 *
 ...
 * - Explicit describe blocks for each parsing category
 * - Tests ordered to match implementation
 * - Test behavior (valid/invalid params) not implementation details
 *
